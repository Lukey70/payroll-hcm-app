(function(){
  ...
  const showTerminatedByTab = { changeCentre:false, jobSummary:false, taxDetails:false, additionalEarnings:false, leave:false, absenceBalance:false, payslip:false };
